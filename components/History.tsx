...
const History = () => {
  ...
  const messages = [
    ...
    "Starting from November 2019, a student scraped data from Taobao for eight months, stealing more than 1.1 Billion user data.",
    ...
    "In September 2022, a local police department's database in China was exposed and hacked due to lack of password protection. Over 10 billion Mainland Chinese resident records were leaked, including names, addresses, places of birth, ID numbers, photos, mobile phone numbers, and criminal case info. This was considered the largest data leak of Chinese citizens in history.",
          ...
          <motion.div
            className={clsx(
              "h-screen flex justify-center items-center bg-gray-800  px-4 text-left font-ApercuBold text-3xl md:text-7xl mt-8 mx-4 md:mt-24 md:ml-12",
                (index === 5 || index === 6) ? `text-red-500` : `text-white`
            )}
            initial={{ opacity: 0 }}
